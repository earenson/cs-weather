...
<script type="text/javascript">
    // Checking user data, can be deleted
...
<div class="side">
    <div class="now">
        ...
        <img src="images/<?php echo strtolower(str_replace(" ","-",$currentArr->currentSummary)) ?>.png" alt="<?php echo strtolower(str_replace(" ","-",$weatherArray[0]['weather_summary_am'])) ?>">
    </div>
    <div class="forecast">
        <div class="tonight">
            <h2>Tonight's Low</h2>
            ...
            <img src="images/<?php echo strtolower(str_replace(" ","-",$weatherArray[0]['weather_summary_am'])) ?>.png" alt="<?php echo strtolower(str_replace(" ","-",$weatherArray[1]['weather_summary_am'])) ?>">
        </div>
        <div class="tomorrow">
